...
def generate_llms_txt(sensors, output_dir):
 ...
 "",
        ...
        "- Playbook: /playbook/ — situational plays: what to point at a symptom, what to add first from where you are, a minimal stack per shape of system",
        "- Atlas: /atlas/ — families arranged as a matrix by lifecycle stage",
        "- Framework: /framework/ — the six dimensions",
        "- What each sensor proves: /what-each-sensor-proves/ — the doubt vocabulary: which sensors close, reveal, or are misread as closing each doubt",
